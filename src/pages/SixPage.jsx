...
function SixPage() {
  ...
  const tabs = [
    { key: "cours", label: "Mes cours", path: "cours", icon: BookOpen, color: "#2563eb" },       // bleu
    ...
    { key: "exercice", label: "Exercices", path: "exercice", icon: Pencil, color: "#f59e0b" },  // orange
  ...
  return (
    <div className="contenairSix" style={{ display: "flex", minHeight: "100vh" }}>
      {/* Side Navigation */}
